...
Unsimilar to Flask, FastAPI not provides event based hooks to open and
close our db connection. We can setting db in dependencies to open the connection when a request is received,
