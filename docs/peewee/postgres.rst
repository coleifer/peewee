...
psycopg2 and psycopg(3) are installed, Peewee defaults to psycopg2 unless
``prefer_psycopg3=True`` is specified:

.. code-block:: python

   # If both psycopg2 and psycopg3 are installed, use psycopg3.
   db = PostgresqlDatabase('peewee_test', prefer_psycopg3=True)
...
.. code-block:: python
   ...
   db = PostgresqlDatabase('my_app', prefer_psycopg3=True,
