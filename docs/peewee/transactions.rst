...
transaction (or savepoint) will be rolled back. Otherwise the statements will
...
.. code-block:: python
   ...
   with db.atomic() as txn:
       # Transaction begins and User is created.
       User.create(username='u1')

   # Transaction committed.

Example of implicit rollback:
...
.. code-block:: python
   ...
   with db.atomic() as transaction:
       try:
           ...
           # Because we are in an "atomic" block, a new transaction
           # will begin automatically we call rollback().
...
.. code-block:: python
   ...
   with db.atomic() as txn:
       # This is the outer-most level. This block corresponds to
       # a transaction.
       ...
       with db.atomic() as nested_txn:
           ...
           # Roll back the above create() query and
