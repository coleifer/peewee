...
class IdentityField(AutoField[_V]):
    def __new__(
        cls, *args: Any, generate_always: bool = False, **kwargs: Unpack[_FieldKwargs]
    ) -> IdentityField[int]: ...
...
class Model(metaclass=ModelBase):
    ...
    # Not classmethod_only[Self, ...]: mypy rejects class access to a
    # Self-generic instance variable, breaking Model.delete() at use sites.
    delete: classmethod_only[Model, ModelDelete]
    @classmethod
