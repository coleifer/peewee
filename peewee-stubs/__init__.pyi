...
class IdentityField(AutoField[_V]):
    def __new__(
        cls, *args: Any, generate_always: bool = ..., **kwargs: Unpack[_FieldKwargs]
    ) -> IdentityField[int]: ...
...
class JSONPath(ColumnBase):
    ...
    def as_text(self, as_text: bool = True) -> JSONPath: ...
    def as_int(self) -> JSONPath: ...
    def as_float(self) -> JSONPath: ...
...
class TimestampField(BigIntegerField[_V]):
    ...
    @overload
    def __new__(
        cls, *args: Any, resolution: int = ..., utc: bool = ..., null: Literal[True], **kwargs: Unpack[_FieldKwargs]
    ) -> TimestampField[datetime | None]: ...
    @overload
    def __new__(
        cls, *args: Any, resolution: int = ..., utc: bool = ..., null: Literal[False] = ..., **kwargs: Unpack[_FieldKwargs]
...
class BaseModelSelect(_ModelQueryHelper):
    ...
    def with_related(
        self, *loads: Load | ForeignKeyField[Any] | BackrefAccessor
    ) -> Self: ...
...
class Load(Node):
    ...
    def then(
        self, *children: Load | ForeignKeyField[Any] | BackrefAccessor
    ) -> Self: ...
